  ...
  return (
    <div className="flex w-full flex-col gap-6 rounded-3xl border-[1.5px] border-brand bg-white p-5 shadow-[0px_16px_16px_rgba(255,108,71,0.05)] sm:gap-7 sm:p-8">
      <div className="flex flex-col gap-1.5">
        <p className="font-display text-lg font-extrabold text-ink sm:text-[22px]">
          What are you preparing for?
        </p>
        <p className="text-sm text-ink-muted">
          We calibrate our questions and evaluations specifically to your target
          parameters.
        </p>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-4 sm:gap-5">
        <Link
          ...
          className="flex items-center justify-center rounded-full bg-brand px-6 py-3 text-[15px] font-semibold text-white shadow-[0px_4px_6px_rgba(255,108,71,0.2)] transition-opacity hover:opacity-90"
        >
