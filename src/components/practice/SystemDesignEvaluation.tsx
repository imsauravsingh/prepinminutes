  ...
  return (
    <div className="flex w-full flex-col gap-6 sm:gap-8">
      ...
      <div className="flex flex-col gap-3">
        ...
        {/* Progress bar (two steps completed/evaluated out of 4) */}
        ...
        <div className="flex flex-col gap-6 rounded-2xl border border-line bg-white p-6 shadow-[0_4px_16px_rgba(30,28,26,0.03)] sm:p-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1.5 pl-8 text-sm text-ink-muted leading-relaxed">
              <p>
                • Good understanding of round-robin and least-connections
                strategies
              </p>
              <p>• Mentioned health checks and failover mechanisms</p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1.5 pl-8 text-sm text-ink-muted leading-relaxed">
              <p>• Discuss consistent hashing for stateful services</p>
              <p>
                • Address how to handle sticky sessions and session persistence
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="pl-8 text-sm text-ink-muted leading-relaxed">
              <p>
                Draw diagrams when explaining system design. Interviewers value
        ...
        <div className="flex flex-col gap-4 pt-1 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="inline-flex items-center gap-2 rounded-xl border border-line bg-white px-4 py-3 shadow-[0_2px_8px_rgba(30,28,26,0.02)]">
            ...
            <div className="flex items-center gap-1.5">
              <span className="text-[13px] text-[#b0a898]">28%</span>
              <span className="text-[13px] text-[#b0a898]">→</span>
              <span className="text-[15px] font-bold text-[#10b981]">35%</span>
