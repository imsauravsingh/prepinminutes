  ...
  return (
    <div className="flex w-full flex-col gap-4 rounded-[20px] border border-brand bg-white p-5 shadow-[0_12px_24px_rgba(255,108,71,0.06)] sm:p-6">
      ...
      <div>
        <Link
          href="/practice"
          className="inline-flex items-center justify-center rounded-full bg-brand px-6 py-2.5 text-[15px] font-semibold text-white shadow-[0px_4px_6px_rgba(255,108,71,0.2)] transition-opacity hover:opacity-90"
        >
          Start Now →
        </Link>
      </div>
